...
export const seahavenPenthouseData = {
  en: {
    ...
    // ✅ Tailored to your required format (ONLY these fields)
    floorPlans: {
      type: "penthouses",
      plans: [
        {
    ...
    // ✅ Location object (EN) – tailored to Sobha SeaHaven (Dubai Harbour)
    location: {
      title: "Project Location",
      projectName: "Sobha SeaHaven",
      address: "Dubai Harbour, Dubai, United Arab Emirates", // :contentReference[oaicite:0]{index=0}
      lat: 25.0898909,
      lng: 55.1441655,
      zoom: 15,
      proximityFeatures: [
  ...
  ar: {
    ...
    // ✅ Location object (AR) – tailored to Sobha SeaHaven (Dubai Harbour)
    location: {
      title: "موقع المشروع",
      projectName: "شوبا سي هيفن",
      address: "دبي هاربور، دبي، الإمارات العربية المتحدة", // :contentReference[oaicite:6]{index=6}
      lat: 25.0898909,
      lng: 55.1441655,
      zoom: 15,
      proximityFeatures: [
        ...
        { icon: "🏙️", text: "حوالي 18–25 دقيقة إلى وسط دبي ودبي مول" }, // :contentReference[oaicite:9]{index=9}
        { icon: "✈️", text: "حوالي 24–38 دقيقة إلى مطار دبي الدولي (DXB)" }, // :contentReference[oaicite:10]{index=10}
        {
          icon: "🛫",
