...
const buildProjectSearchText = (project) => {
  ...
  fields.forEach((field) => {
    if (project[field]) texts.push(String(project[field]));
  });
  ...
  if (regionSlug) {
    ...
    if (arRegion) texts.push(arRegion);
  }
