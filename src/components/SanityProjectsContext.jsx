...
function normalizeLegacyProperty(property) {
  ...
  return {
    ...
    unitTypeAr: property?.unitTypesAr || property?.ar?.project?.type || "",
    status: normalizedStatus,
    statusDisplayAr: property?.statusDisplayAr || "",
    ...
    startingPrice: project?.startingPrice || "",
    completionDate: project?.completionDate || "",
    completionDateAr: property?.completionDateAr || property?.ar?.project?.completionDate || "",
    ...
    paymentPlan: project?.paymentPlan || property?.paymentPlan || "",
    saleStatus: "",
...
function normalizeFlatProperty(property) {
  ...
  return {
    ...
    unitTypeAr: property?.unitTypesAr || property?.propertyTypeAr || "",
    status: normalizedStatus,
    statusDisplayAr: property?.statusDisplayAr || "",
    devStatus: normalizedStatus,
    location,
    ...
    startingPrice: property?.startingPrice || "",
    completionDate: property?.completionDate || "",
    completionDateAr: property?.completionDateAr || "",
